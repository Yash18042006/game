...
function preload() {
  ...
  ground1_img = loadImage("Jungle Map/Platformer/Ground_10.png")
  ...
  wall2_img = loadImage("Jungle Map/Platformer/Bridge_02.png");
...
function setup() {
  ...
  invisibleGround.addImage("Ground1", ground1_img);
  invisibleGround.debug=true;

  wall2 = createSprite(50,400,100,20);
  wall2.addImage("wall1", wall1_img);
  wall2.debug=true;
